...
public class SaboreArteDeliveryApplicationTests {
	...
	public void findClientesByNome() throws Exception {
		...
		String URL2="/api/clientes/search/findByNomeAllIgnoringCase?nome=alan santos";
		...
		this.mvc.perform(
				...
				.andExpect(jsonPath("endereco", equalTo("Salvador")));
	}

	@Test
	public void findClientesByNomeContaining() throws Exception {

		String URL3="/api/clientes/search/findByNomeContainingAllIgnoringCase?nome=a";
